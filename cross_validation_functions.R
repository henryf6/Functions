...
##
## Notes: Probably a bad first attempt at writing functions, but hey it
## gets the job done
## ******************************************************************** ##
...
CV_factor <- function(data, stat.method = c('pfr','plsr','lm'), formula,
...
#spectra_traits_analysis <- spectra_traits_analysis[complete.cases(spectra_traits_analysis[,c(8,9,49,56)]),]
#spectra_traits_analysis$Latitude <- jitter(spectra_traits_analysis$Latitude, amount = .0001)
